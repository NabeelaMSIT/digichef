...
Additionally, our project avoids clutter, which most websites of similar scope are plagued with, for example recipeZaar.com. With a user’s short attention span, purging superfluous information from our website prevents distracting users when they use our services.
...
\footnote{[Link to research, 31st March 2010 \url{http://desktoppub.about.com/cs/colorselection/p/orange.htm}]} 
